...
var sparkResize, ctx = $("#payments-chart"),
    chartOptions = {
        responsive: !0,
        ...
        title: {
            display: !0,
            text: "RAPPORT ADHERENT/RESERVATION"
        }
    },
    chartData = {
        labels: ["JANVIER", "FERVRIER", "MARS", "AVRIL", "MAI", "JUIN", "JUILLET", "AOUT", "SEPTEMBRE", "NOVEMBRE", "DECEMBRE"],
        datasets: [{
            label: "Adherents",
            data: dataAdherent,
...
$(window).resize((function(o) {
    clearTimeout(sparkResize), sparkResize = setTimeout(reports, 500)
})), reports();