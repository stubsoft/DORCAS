! function i(a, c, d) {
            ...
            this.jKanban = function() {
                ...
                arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, t) {
                    ...
                    for (var i in e) {
                        ...
                        if ("" !== a.class && void 0 !== a.class) var u = a.class.split(",");
                        else u = [];
                        if (d.classList.add("kanban-board-header"), u.map(function(e) {
                                d.classList.add(e)
                            }), d.innerHTML = '<div class="kanban-title-board">' + a.title + "</div>", r) {
                            var l = document.createElement("BUTTON"),
                                s = document.createTextNode(o);
                            l.setAttribute("class", "kanban-title-button btn btn-default btn-xs"), l.appendChild(s), d.appendChild(l), w(l, a.id)
                        }
                        var f = document.createElement("main");
                        if (f.classList.add("kanban-drag"), "" !== a.bodyClass && void 0 !== a.bodyClass) var p = a.bodyClass.split(",");
                        else p = [];
                        for (var v in p.map(function(e) {
                            ...
                            g.classList.add("kanban-item"), m.id && (g.dataset.eid = m.id), g.innerHTML = m.title, g.clickfn = m.click, g.dragfn = m.drag, g.dragendfn = m.dragend, g.dropfn = m.drop, E(g, m), y(g), f.appendChild(g)
                        }
                        var h = document.createElement("footer");
                        c.appendChild(d), c.appendChild(f), c.appendChild(h), b.container.appendChild(c)
                    }
                    return b
                    ...
                    var t = null;
                    "string" == typeof e && (t = b.element.querySelector('[data-id="' + e + '"]')), null !== t && t.remove();
                    for (var n = 0; n < b.options.boards.length; n++)
                        if (b.options.boards[n].id === e) {
                            b.options.boards.splice(n, 1);
                            break
                        }
                    return b
            ...
            return void 0 === o && (o = {}), o.on = function(e, t) {
                ...
                return function() {
                    ...
                    return e.forEach(function(e) {
                        i.async ? d(e, t, n) : e.apply(n, t), e._once && o.off(r, e)
                    }), o
                }
            }, o
        }
            ...
            function u(e, t, n) {
                var r = function(e, t, n) {
                    ...
                    for (r = 0; r < d.length; r++)
                        if ((o = d[r]).element === e && o.type === t && o.fn === n) return r
                }(e, t, n);
                if (r) {
                    var o = d[r].wrapper;
                    return d.splice(r, 1), o
                }
            }
            o.addEventListener || (e = function(e, t, n) {
                return e.attachEvent("on" + t, function(e, t, n) {
                    var r = u(e, t, n) || function(n, e, r) {
                        return function(e) {
                            var t = e || o.event;
            ...
            t.exports = function(e, t) {
                ...
                function s(e) {
                    if (i = e.clientX, a = e.clientY, !(1 !== U(e) || e.metaKey || e.ctrlKey)) {
                        var t = e.target,
                            n = k(t);
                        n && (c = n, u(), "mousedown" === e.type && (Q(t) ? t.focus() : e.preventDefault()))
                    }
                }
                ...
                function q(e) {
                    if (p) {
                        ...
                        var i = w || m,
                            ...
                            c = P(a, t, n),
                            d = null !== c && c !== E;
                        !d && null !== c || (E && f("out"), E = c, d && f("over"));
                        var u = J(i);
                        if (c !== v || !w || T.copySortSource) {
                            var l, s = D(c, a);
                            if (null !== s) l = X(c, s, t, n);
                            else {
                                if (!0 !== T.revertOnSpill || w) return void(w && u && u.removeChild(i));
                                l = b, c = v
                            }(null === l && d || l !== i && l !== Z(i)) && (y = l, c.insertBefore(i, l), C.emit("shadow", i, c, v))
                        } else u && u.removeChild(i)
                    }
    ...
    10: [function(e, t, n) {
        ...
        function p() {
            s && u && (s = !1, u.length ? l = u.concat(l) : f = -1, l.length && v())
        }
        ...
        i.nextTick = function(e) {
            ...
            l.push(new m(e, t)), 1 !== l.length || s || d(v)
    ...
    12: [function(d, e, u) {
        (function(e, t) {
            var r = d("process/browser.js").nextTick,
            ...
            u.setTimeout = function() {
                ...
                return i[t] = !0, r(function() {
                    i[t] && (n ? e.apply(null, n) : e.call(null), u.clearImmediate(t))
                }), t
